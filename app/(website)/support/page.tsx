              ...
              <div className="space-y-4">
                ...
                <ol className="list-decimal list-inside space-y-4">
                  ...
                  <li>
                    ...
                    <p className="text-sm">
                      The more people who know about osu!tosume, the more
                  ...
                  <li>
                    ...
                    <p className="text-sm">
                      One of the easiest ways to support osu!tosume is simply
